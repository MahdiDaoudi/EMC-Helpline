...
export async function createOrganization(
    ...
    const result = await organizationsService.addOrganization(req.body);
...
export async function updateOrganization(
    ...
    const result = await organizationsService.updateOrganization(Number(req.params.id), req.body);
    res.json(result);
}
