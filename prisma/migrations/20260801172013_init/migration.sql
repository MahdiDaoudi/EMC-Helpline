...
CREATE TABLE `Victime` (
    ...
    UNIQUE INDEX `Victime_referenceNumber_key`(`referenceNumber`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `Signalement` ADD CONSTRAINT `Signalement_victimeId_fkey` FOREIGN KEY (`victimeId`) REFERENCES `Victime`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
